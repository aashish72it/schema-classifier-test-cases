...
subprocess.run('schema-detect data/csv/sales_header.csv --output-dir ./cli', shell=True, check=True)
...
subprocess.run('schema-detect data/json/events.ndjson --fmt dict --output-dir ./cli --output-file schema_json_dict.yml', shell=True, check=True)
subprocess.run('schema-detect data/csv/sales_header.csv --fmt yaml --output-dir ./cli --output-file schema_sales_header.yml', shell=True, check=True)
